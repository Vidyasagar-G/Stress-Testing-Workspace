...
class VariationalAutoencoderReducer:
    def __init__(self, returns_matrix, latent_dim=5, epochs=100, batch_size=32):
        ...
        self.decoder = lambda z: self.vae_model.decode(z).numpy()
    ...
    def sample_from_posterior(self, n_samples=1000):
        """
        Samples n times from the learned posterior distribution q(z|x)
        using the reparameterization trick.
        Returns an array of shape (n_samples, T, latent_dim)
        """
